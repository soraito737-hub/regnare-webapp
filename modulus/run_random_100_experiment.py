"""
本当に適当なアンチコメント100件(非該当多め)でのLLM判定 実験スクリプト
========================================================================
data/test_dataset_random_100.json(40件のアンチコメント + 60件の非該当)を使い、
llm_classifier.py の精度を検証する。run_casual_100_experiment.py と同じロジック。
"""
...
def main(limit: int | None = None):
    ...
    print(f"{len(test_data)}件のコメントを読み込みました")

    out_path = Path(__file__).parent.parent / "data" / "experiment_random_100_results.json"
